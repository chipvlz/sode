...
var paygoc = 3 * hesoDai * parseFloat(betDetail[5]) * 1000;
...
var paygoc = parseFloat(betDetail[detailTien]) * numDai * 6 * 17 * 1000;
} else if (n1 == n2 || n2 == n3 || n1 == n3) {
...
var totalPay = parseFloat(betDetail[detailTien]) * numDai * 24 * 16 * bonus1 * 1000;
var paygoc = parseFloat(betDetail[detailTien]) * numDai * 24 * 16 * 1000;
}

else if (n1 == n2 && n3 == n4 && n1 != n3) {
var totalPay = parseFloat(betDetail[detailTien]) * numDai * 6 * 16 * bonus1 * 1000;
...
if(sumtongLoi < 0) {
$('#page-bet-cal span.tongket').append(', Có <strong class="hAllmsg">'+sumTN+'</strong> tin nhắn đến, hôm nay chung <strong class="hTotal">'+tongloiShow+'</strong>');
} else {
$('#page-bet-cal span.tongket').append(', Có <strong class="hAllmsg">'+sumTN+'</strong> tin nhắn đến, hôm nay thu vào <strong class="hTotal">'+tongloiShow+'</strong>');
}
})
